...
def load_config():
    ...
    cfg.setdefault("educoder_phone", os.environ.get("EDUCODER_PHONE", ""))
    cfg.setdefault("educoder_password", os.environ.get("EDUCODER_PASSWORD", ""))
    cfg.setdefault("mooc_cookie", os.environ.get("MOOC_COOKIE", ""))
    cfg.setdefault("mooc_phone", os.environ.get("MOOC_PHONE", ""))
    cfg.setdefault("mooc_password", os.environ.get("MOOC_PASSWORD", ""))
